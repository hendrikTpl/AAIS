...
"""
    This code is borrowed from https://github.com/pwwiur/hough-counter
    It can be used for pipes detection and labelling purposes. 
    The file is saved to xml as the same  "labelImg" 
